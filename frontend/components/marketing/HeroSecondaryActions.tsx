  ...
  return (
    <div className={cn("grid grid-cols-2 gap-2 sm:gap-3", className)}>
      <Link
        ...
        className="group flex min-h-[4.25rem] flex-col justify-center rounded-2xl border border-primary/20 bg-primary px-3 py-3 text-left shadow-sm transition-all hover:bg-primary/90 sm:min-h-[4.5rem] sm:px-4"
      >
      ...
      <Link
        ...
        className="group flex min-h-[4.25rem] flex-col justify-center rounded-2xl border border-border/70 bg-white px-3 py-3 text-left shadow-sm transition-all hover:border-primary/25 hover:bg-muted/30 sm:min-h-[4.5rem] sm:px-4"
      >
