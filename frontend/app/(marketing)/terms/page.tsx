...
export default function TermsPage() {
  return (
    <LegalPageLayout title="Terms & Conditions" lastUpdated="10 June 2026">
      ...
      <h2>3. Estimates and AI Limitations</h2>
      <p>
        Any tax, refund, or amount payable shown in the app is an <strong>illustrative estimate</strong> based on the information
        you provide and tax law as understood at build time. Our platform utilises probabilistic
        Artificial Intelligence (AI) models to parse documents and compute figures.{" "}
        <strong>AI is not infallible and may produce inaccurate, incomplete, or incorrectly mapped outputs.</strong>{" "}
        Final tax, refund, demand, interest,
        or penalty is determined solely by the Income Tax Department after it processes your return.
        We make <strong>no guarantee</strong> of 100% accuracy, refund amount, refund eligibility, or
        processing time.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Act as your own auditor.</strong> You agree that you are solely responsible for
          verifying every figure generated by our AI against your original documents before entering
          them on the Income Tax Portal. You are exclusively responsible for the correctness of what
          you file.
        </li>
      ...
      <p>
        ...
        from: data you entered, errors or misinterpretations generated by our AI software, your final filing decisions, portal outages or errors, changes in
        tax law after your filing date, or events outside our reasonable control. You expressly understand that software and AI calculations are assistive tools and do not substitute human diligence. Where liability
      ...
      <h2>14. Indemnity</h2>
      <p>
        You agree to indemnify and hold us harmless against any claims, losses, penalties from tax authorities, ITD notices, and costs arising from your breach of these
        Terms, your reliance on unverified AI-generated figures, your misuse of the service, or inaccurate or unlawful information you submit.
      </p>
