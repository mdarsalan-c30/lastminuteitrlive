...
import { buildItr2Export } from "@/lib/itr/itdJsonExport";
...
export async function POST(request: NextRequest) {
  ...
  return new NextResponse(JSON.stringify(payload, null, 2), {
    ...
    headers: {
      ...
      "Content-Disposition": 'attachment; filename="lastminute-itr-itr2-ay2026-27.json"',
