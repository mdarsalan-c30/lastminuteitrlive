...
export const ITR_FORMS_REFERENCE: readonly ItrFormRow[] = [
  {
    ...
    support: "guided",
    supportLabel: "Self-file with guided steps",
  },
  {
    form: "ITR-2",
    whoShouldFile:
  ...
  },
  {
    ...
    support: "guided",
    supportLabel: "Guided ITR-3 and trading schedules",
  },
  {
    form: "ITR-4",
    nickname: "Sugam",
...
export const AI_CA_CONFIDENCE_HEADLINE =
  "We suggest the ITR form that may apply, read supported documents, and guide you through filing.";
